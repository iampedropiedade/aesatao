...
namespace DoctrineProxies\__CG__\Concrete\Package\MultipleFiles\Entity\Attribute\Key\Settings;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class MultipleFilesSettings extends \Concrete\Package\MultipleFiles\Entity\Attribute\Key\Settings\MultipleFilesSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'akMaxFilesCount', 'key'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MultipleFilesSettings $proxy) {
    ...
    public function getMaxFilesCount(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMaxFilesCount', []);

        return parent::getMaxFilesCount();
    }

    /**
     * {@inheritDoc}
     */
    public function setMaxFilesCount($maxFilesCount): \Concrete\Package\MultipleFiles\Entity\Attribute\Key\Settings\MultipleFilesSettings
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMaxFilesCount', [$maxFilesCount]);

        return parent::setMaxFilesCount($maxFilesCount);
    }

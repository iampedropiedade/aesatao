...
<section
    ...
    <div class="container pt-28 pb-20 sm:!py-28 xxl:!py-40">
        <div class="flex flex-wrap mx-[-15px]">
            <div class="xl:w-6/12 lg:w-6/12 md:w-6/12 sm:w-6/12 xxl:w-5/12 w-full flex-[0_0_auto] px-[15px] max-w-full xsm:!text-center text-left <?php if($textColor === 'light') : ?> !text-gray-200 <?php else: ?> !text-white <?php endif; ?>">

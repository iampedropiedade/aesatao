<?php
namespace Application\Block\Banner;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btCustomBanner';
    ...
    public function view()
    {
        ...
        if($this->get('buttonL2inkToSection')) {
            $this->set('button2LinkUrl', $this->get('button2LinkToSection'));
        }
        elseif($this->get('button2PageId')) {
            $page = Page::getByID($this->get('button2PageId'));
            $this->set('page', $page ?? null);
            $this->set('button2LinkUrl', $page?->getCollectionLink());
            $this->set('button2Caption', $this->get('button2Caption') ?: $page?->getCollectionName());
        }
